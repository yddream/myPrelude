...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face ((t (:foreground ,"deep sky blue" :background ,alt-background :italic t ))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,"deep sky blue" :background ,alt-background :italic t ))))
   ...
   `(mode-line ((t (:foreground ,gray-2 :background ,gray-3bg ))))
   ...
   ;;-----------------------------------------------------------------------------------------------------------------------
   ;; Linum
   `(linum ((t (:foreground ,gray-1 :background ,alt-background :height 90 ))))
   ;;-----------------------------------------------------------------------------------------------------------------------
   ;; show-paren-mode
