...
(global-set-key (kbd "s-<down>") 'tabbar-backward-group)  ;; 这几句的目的是绑定快捷键这样就可以直接用快捷键来操做了。
(global-set-key (kbd "s-<up>") 'tabbar-forward-group) ;;不过没有发现有很大用处，所以注释了。
...
;;                    :foreground "#839496"
                    ...
                    :box '(:line-width 3 :color "#002b36" :style nil))
